export const searchItems = [
  ...
  { title: 'Tetris (Void Blocks)', path: '/games/tetris', category: 'Game', icon: 'Layers' },
  { title: 'Flappy Bird (Neon)', path: '/games/flappy-bird', category: 'Game', icon: 'Wind' },
  { title: '2048 (Merge Engine)', path: '/games/2048', category: 'Game', icon: 'Zap' },
  { title: 'Pong AI', path: '/games/pong', category: 'Game', icon: 'Activity' },
  ...
  { title: 'Contact / Email', path: 'mailto:sohamd008@gmail.com', category: 'External', icon: 'Mail' },
  { title: 'Swaramanjusha Archive', path: 'https://swaramanjusha.eu.org', category: 'External', icon: 'Music' },
];
